        ...
        >
          ...
          <div className="flex items-center px-6 pt-3 border-b border-slate-100 gap-4">
            ...
            >
              ...
              {activeTab === "searches" && (
                <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#167d4f] rounded-full" />
              )}
            </button>
            ...
            >
              ...
              {unreadNotificationsCount > 0 && (
                <span className="ml-1.5 px-2 py-0.5 rounded-full text-[10px] bg-[#167d4f] text-white font-extrabold">
                  {unreadNotificationsCount}
                </span>
              )}
              {activeTab === "alerts" && (
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      {onApplySearch && (
                        <button
                          ...
                          className="px-3 py-1.5 rounded-xl bg-[#167d4f] text-white hover:bg-[#167d4f] text-xs font-bold transition-all"
                        >
                  ...
                  <div
                    ...
                    className={`p-4 rounded-2xl border transition-all cursor-pointer flex items-start justify-between gap-3 ${
                      notif.read
                        ...
                        : "bg-[#eaf5f0]/40 border-[#2db477]/30 text-slate-900 shadow-xs"
                    }`}
                  >
                    <div className="space-y-1 flex-1">
                      <div className="flex items-center gap-2">
                        {!notif.read && (
                          <span className="h-2 w-2 rounded-full bg-[#167d4f] shrink-0" />
                        )}
                    ...
                    <ExternalLink className="h-4 w-4 text-[#167d4f] shrink-0 mt-0.5" />
                  </div>
                ))}
              </div>
            )}
