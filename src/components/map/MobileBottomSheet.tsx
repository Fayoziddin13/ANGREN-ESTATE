    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="p-3.5 pt-1 space-y-2.5">
            ...
            >
              ...
              <div className="absolute top-1.5 left-1.5 flex items-center gap-1">
                ...
                {isHouse && property.area_sotikh && (
                  <span className="rounded-lg bg-[#167d4f]/80 backdrop-blur-sm px-1.5 py-0.5 text-[9px] font-semibold text-white/80 shadow-xs">
                ...
                {property.property_type === "land" ? (
                  <div className="flex items-center gap-2">
                    {property.area_sotikh ? (
                      <span className="font-bold text-[#167d4f]">{property.area_sotikh} {locale === "uz" ? "sotix" : "сот."}</span>
                    ) : null}
                  ...
                  <div className="flex items-center gap-2">
                    {floorNum ? (
                      <div className="flex items-center gap-1 font-bold text-gray-700">
                        <Layers className="h-3 w-3 text-[#167d4f]" />
          ...
          <button
            onClick={() => onViewDetails(property)}
            className="w-full flex items-center justify-center gap-1.5 rounded-xl bg-[#167d4f] py-2 text-xs font-bold text-white shadow-card active:scale-[0.98] transition-all"
          >
