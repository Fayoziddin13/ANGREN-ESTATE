...
export function AngrenMap({
  ...
  useEffect(() => {
    ...
    clusters.forEach((cluster) => {
      ...
      el.innerHTML = `
        <div class="angren-cluster-inner flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#0c2e1f] text-white font-extrabold text-xs shadow-xl border-2 border-white/95 backdrop-blur-md">
          <span style="display:inline-block; width:6px; height:6px; border-radius:50%; background:#339e71; box-shadow:0 0 6px #339e71;"></span>
    ...
    individualProps.forEach((property) => {
      ...
      const ringBorder = isSelected
        ? isSale
          ? "ring-4 ring-[#339e71]/60 border-2 border-[#339e71]"
      ...
      <div className={`flex flex-col items-center gap-1.5 absolute ${effectiveControlsBottom} right-3 sm:right-5 z-20 pointer-events-auto`}>
        ...
        <button
          ...
          className={`hidden sm:flex sm:h-10 sm:w-10 flex-col items-center justify-center rounded-2xl backdrop-blur-xl shadow-elevated border transition-all active:scale-95 ${
            dimension === "3d"
              ? "bg-[#0c2e1f] text-white border-[#0c2e1f] ring-2 ring-[#339e71]/40"
              : "bg-white/90 text-gray-700 hover:text-[#0c2e1f] border-white/80 hover:bg-white"
          }`}
        >
        ...
        <button
          ...
          className="hidden sm:flex sm:h-10 sm:w-10 items-center justify-center rounded-2xl bg-white/90 backdrop-blur-xl text-gray-700 hover:text-[#0c2e1f] shadow-elevated border border-white/80 hover:bg-white transition-all active:scale-95"
        >
        ...
        <div className="flex flex-col rounded-2xl bg-white/95 backdrop-blur-xl shadow-elevated border border-white/80 overflow-hidden">
          <button
            ...
            className="flex h-9 w-9 sm:h-9 sm:w-10 items-center justify-center text-gray-700 hover:text-[#0c2e1f] hover:bg-white transition-colors border-b border-gray-100 active:scale-95"
            aria-label="Zoom In"
          >
          ...
          <button
            ...
            className="flex h-9 w-9 sm:h-9 sm:w-10 items-center justify-center text-gray-700 hover:text-[#0c2e1f] hover:bg-white transition-colors active:scale-95"
            aria-label="Zoom Out"
          >
