    ...
    >
      ...
      >
        ...
        <div className="absolute top-2.5 left-2.5 z-10 flex items-center gap-1.5">
          ...
          {property.area_sotikh && (property.property_type === "house_yard" || property.property_type === "land") && (
            <span className="rounded-lg bg-emerald-950/80 backdrop-blur-md px-1.5 py-0.5 text-[10.5px] font-semibold text-emerald-200 shadow-xs">
      ...
      <div className="p-3.5 space-y-2.5">
        <div className="cursor-pointer" onClick={() => onViewDetails(property)}>
          <div className="text-base sm:text-lg font-extrabold tracking-tight text-[#0d3431]">
            {priceDisplay}
          </div>
          <h3 className="text-xs sm:text-sm font-bold text-gray-900 line-clamp-1 hover:text-[#19453c] transition-colors">
            {title}
          </h3>
        ...
        <div className="flex items-center justify-between border-t border-[#E8ECE9] pt-2 text-[11px] font-semibold text-gray-600">
            ...
            <div className="flex items-center gap-2">
              {floorNum ? (
                <div className="flex items-center gap-1 font-bold text-gray-700">
                  <Layers className="h-3.5 w-3.5 text-[#19453c]" />
        ...
        <button
          onClick={() => onViewDetails(property)}
          className="group w-full flex items-center justify-center gap-1.5 rounded-xl bg-[#0d3431] py-2 text-xs font-bold text-white shadow-card hover:bg-[#19453c] active:scale-[0.98] transition-all"
        >
