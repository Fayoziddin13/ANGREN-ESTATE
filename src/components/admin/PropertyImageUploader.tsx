    ...
    <div className="space-y-4">
      ...
      <div
        ...
        className={`relative border-2 border-dashed rounded-3xl p-6 sm:p-8 text-center transition-all cursor-pointer ${
          isDragging
            ? "border-[#0d3431] bg-[#d9eedb]/40 ring-4 ring-[#8cb599]/30"
            : "border-slate-200 bg-slate-50/70 hover:bg-slate-50 hover:border-[#8cb599]"
        } ${isUploading ? "pointer-events-none opacity-80" : ""}`}
      >
        <div className="flex flex-col items-center justify-center space-y-3">
          <div className="w-14 h-14 rounded-2xl bg-white shadow-xs border border-slate-200 flex items-center justify-center text-[#0d3431]">
            {isUploading ? (
              <Loader2 className="w-7 h-7 animate-spin text-[#0d3431]" />
            ) : (
          ...
          {!isUploading && (
            <div className="pt-1">
              <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#0d3431] text-white text-xs font-bold shadow-xs hover:bg-[#19453c] transition-colors">
      ...
      {/* Success Toast */}
      {successMessage && (
        <div className="p-3 rounded-2xl bg-[#d9eedb]/50 border border-[#8cb599]/40 flex items-center gap-2 text-xs text-[#0d3431] font-bold">
          <CheckCircle2 className="w-4 h-4 text-[#19453c] shrink-0" />
      ...
      <div className="flex items-center justify-between text-xs text-slate-500 pt-1">
        ...
        <button
          ...
          className="text-[#0d3431] hover:underline font-bold flex items-center gap-1"
        >
      ...
      {showUrlFallback && (
        <div className="p-3 bg-slate-50 border border-slate-200 rounded-2xl flex gap-2">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#0d3431] text-white text-xs font-bold rounded-xl hover:bg-[#19453c]"
          >
            ...
            return (
              <div
                ...
                className={`relative aspect-[3/4] rounded-2xl overflow-hidden group border transition-all ${
                  isMain
                    ? "border-[#0d3431] ring-2 ring-[#0d3431] shadow-md"
              ...
              >
                ...
                {isMain ? (
                  <div className="absolute top-2 left-2 z-10 flex items-center gap-1 px-2.5 py-1 rounded-xl bg-[#0d3431] text-white text-[10px] font-black tracking-wide shadow-md">
                  ...
                  <button
                    ...
                    className="absolute top-2 left-2 z-10 flex items-center gap-1 px-2 py-1 rounded-xl bg-black/60 hover:bg-[#0d3431] text-white text-[10px] font-bold opacity-0 group-hover:opacity-100 transition-all shadow-sm"
