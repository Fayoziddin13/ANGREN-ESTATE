...
export function HududPolygonDrawerModal({
  ...
  useEffect(() => {
    ...
    points.forEach(([lat, lng], idx) => {
      ...
      el.className =
        "w-6 h-6 rounded-full bg-[#0d3431] border-2 border-white text-white flex items-center justify-center text-[10px] font-black shadow-md cursor-pointer hover:scale-110 transition-transform";
      el.innerText = `${idx + 1}`;
          ...
          <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="relative flex-1 h-72 md:h-auto min-h-[320px]">
              ...
              <div className="absolute top-3 right-3 flex items-center gap-2 z-10">
                ...
                >
                  <Layers className="h-3.5 w-3.5 text-[#0d3431]" />
                  <span>
                    {mapMode === "standard"
                      ? locale === "uz"
                        ? "Sun’iy yo‘ldosh"
            ...
            <div className="w-full md:w-80 p-5 bg-slate-50 border-t md:border-t-0 md:border-l border-slate-200 flex flex-col justify-between overflow-y-auto">
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 bg-white text-xs font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#19453c]/20 focus:border-[#19453c]"
                  />
                </div>
                ...
                {points.length >= 3 && !isClosed && (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-[#d9eedb]/40 border border-[#8cb599]/60 text-[#0d3431] text-xs font-extrabold hover:bg-[#d9eedb]/70 transition-all"
                  >
              ...
              <div className="pt-4 border-t border-slate-200 mt-4">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-2xl bg-[#0d3431] hover:bg-[#19453c] disabled:opacity-50 text-white text-xs font-extrabold shadow-md active:scale-[0.98] transition-all"
                >
