...
export function HududPolygonDrawerModal({
  ...
  useEffect(() => {
    ...
    points.forEach(([lat, lng], idx) => {
      ...
      el.className =
        "w-6 h-6 rounded-full bg-[#16543C] border-2 border-white text-white flex items-center justify-center text-[10px] font-black shadow-md cursor-pointer hover:scale-110 transition-transform";
      el.innerText = `${idx + 1}`;
