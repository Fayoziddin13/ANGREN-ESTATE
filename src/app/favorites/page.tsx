...
export default function FavoritesPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900">
      ...
      {/* 2. Top Banner */}
      <div className="bg-[#0c2e1f] text-white py-8 sm:py-12 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1.5">
              <div className="flex items-center gap-2 text-[#339e71] text-xs font-bold tracking-wider uppercase">
              ...
              <p className="text-xs sm:text-sm text-[#e5f0eb]/90">
                {locale === "uz"
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/"
                className="flex items-center gap-1.5 px-4 py-2 rounded-2xl bg-white text-[#0c2e1f] hover:bg-[#e5f0eb]/40 text-xs font-bold shadow-md transition-all active:scale-95"
              >
      ...
      <main className="flex-1 mx-auto max-w-7xl w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        {!user ? (
          ...
          <div className="max-w-md mx-auto text-center py-16 px-6 rounded-3xl bg-white border border-slate-100 shadow-card space-y-5">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-[#e5f0eb]/40 text-[#0c2e1f] shadow-inner">
              <Lock className="h-8 w-8 text-[#19573c]" />
            </div>
            ...
            <div className="pt-3">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-3 rounded-2xl bg-[#0c2e1f] px-6 py-3.5 text-xs font-extrabold text-white shadow-elevated hover:bg-[#19573c] active:scale-[0.99] transition-all"
              >
          ...
          <div className="max-w-md mx-auto text-center py-16 px-6 rounded-3xl bg-white border border-slate-100 shadow-card space-y-4">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-[#e5f0eb]/40 text-[#0c2e1f] shadow-inner">
              <Heart className="h-8 w-8 text-[#19573c]" />
            </div>
            <div className="space-y-2">
              <h2 className="text-lg sm:text-xl font-black text-slate-900">
            ...
            <div className="pt-2">
              <Link
                href="/"
                className="inline-flex items-center gap-2 rounded-2xl bg-[#0c2e1f] px-6 py-3 text-xs font-extrabold text-white shadow-elevated hover:bg-[#19573c] active:scale-95 transition-all"
              >
