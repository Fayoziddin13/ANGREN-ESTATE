...
export default function AdminContentPage() {
  ...
  return (
    <div className="p-4 sm:p-8 max-w-7xl mx-auto w-full space-y-6 pb-16">
      {/* Toast Notification */}
      {toastMessage && (
        <div className="fixed top-6 right-6 z-50 bg-[#167d4f] border border-[#167d4f] text-white px-5 py-3 rounded-xl shadow-xl flex items-center gap-2 animate-in fade-in slide-in-from-top-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl lg:text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3">
            <FileText className="w-7 h-7 text-[#167d4f]" />
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2 bg-[#167d4f] hover:bg-[#167d4f] text-white rounded-xl font-bold text-sm shadow-sm hover:shadow-md transition-all disabled:opacity-50"
          >
      ...
      <div className="p-4 bg-[#eaf5f0]/60 border border-[#bdd1c8] rounded-2xl flex items-center gap-3 text-xs text-[#167d4f] font-medium">
        <Globe className="w-5 h-5 text-[#167d4f] flex-shrink-0" />
        <div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-6">
            <h2 className="text-base font-bold text-slate-900 flex items-center gap-2">
              <Sparkles className="w-5 h-5 text-[#167d4f]" />
          ...
          <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
            <div className="text-xs font-bold text-[#167d4f] uppercase tracking-wider mb-3 flex items-center gap-1.5">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-xs text-center space-y-3">
              <span className="inline-block px-3 py-1 rounded-full bg-[#eaf5f0]/60 border border-[#bdd1c8] text-[11px] font-bold text-[#167d4f]">
      ...
      {activeTab === "about" && (
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-6">
          <h2 className="text-base font-bold text-slate-900 flex items-center gap-2">
            <Layers className="w-5 h-5 text-[#167d4f]" />
      ...
      {activeTab === "announcement" && (
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-base font-bold text-slate-900 flex items-center gap-2">
                <Megaphone className="w-5 h-5 text-[#167d4f]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-slate-200">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                {[
                  { id: "info", uz: "Axborot (Yashil)", color: "border-[#167d4f] bg-[#eaf5f0]/60 text-[#167d4f]" },
                  { id: "warning", uz: "Ogohlantirish (Sariq)", color: "border-amber-600 bg-amber-50 text-amber-800" },
                  { id: "success", uz: "Muvaffaqiyat (Yorqin)", color: "border-[#167d4f] bg-[#eaf5f0]/60 text-[#167d4f]" },
                ].map((item) => (
                  <button
                    type="button"
                    key={item.id}
      ...
      {activeTab === "seo" && (
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-6">
          <h2 className="text-base font-bold text-slate-900 flex items-center gap-2">
            <Search className="w-5 h-5 text-[#167d4f]" />
      ...
      <div className="flex justify-end pt-4">
        <button
          ...
          onClick={() => handleSaveSection(activeTab)}
          disabled={isSaving || isLoading}
          className="flex items-center gap-2 px-6 py-3 bg-[#167d4f] hover:bg-[#167d4f] text-white rounded-xl font-bold text-sm shadow-sm hover:shadow-md transition-all disabled:opacity-50"
        >
          <Save className="w-4 h-4" />
          {isSaving
            ? locale === "uz" ? "Saqlanmoqda..." : "Сохранение..."
