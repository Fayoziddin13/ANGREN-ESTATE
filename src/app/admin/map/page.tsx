...
export default function AdminMapManagementPage() {
  ...
  return (
    <div className="h-[calc(100vh-65px)] flex flex-col lg:flex-row overflow-hidden relative">
      {/* Toast */}
      {toastMessage && (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 bg-[#167d4f] text-white px-5 py-2.5 rounded-2xl shadow-xl text-xs font-bold flex items-center gap-2 border border-[#167d4f]/40 animate-bounce">
      ...
      <div className="flex-1 h-full relative">
        ...
        <div className="absolute top-4 left-4 z-10 flex items-center gap-2">
          ...
          >
            <Crosshair className="h-4 w-4 text-[#167d4f]" />
          </button>
        </div>
        ...
        <div className="absolute bottom-6 left-4 z-10 bg-white/95 backdrop-blur-md rounded-2xl p-3 shadow-elevated border border-slate-200 text-[11px] font-bold space-y-1.5">
          ...
          <div className="flex items-center gap-3">
            <span className="flex items-center gap-1.5 text-[#167d4f]">
              <span className="h-2.5 w-2.5 rounded-full bg-[#167d4f]" /> {locale === "uz" ? "Nashr qilingan" : "Опубликовано"}
            </span>
      ...
      <div className="w-full lg:w-96 bg-white border-l border-slate-200 flex flex-col h-full z-10 shadow-lg">
        ...
        <div className="p-4 border-b border-slate-200 space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-black text-slate-900 flex items-center gap-2">
              <Compass className="h-4 w-4 text-[#167d4f]" />
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-1.5 text-xs rounded-xl border border-slate-200 bg-slate-50 outline-none focus:ring-2 focus:ring-[#167d4f]"
            />
          </div>
        ...
        {selectedProperty ? (
          <div className="p-4 bg-[#eaf5f0]/60/40 border-b border-[#bdd1c8]/60 space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-bold uppercase tracking-wider text-[#167d4f]">
            ...
            {/* Coordinates editor */}
            <div className="space-y-2 pt-2 border-t border-[#bdd1c8]/50">
              <div className="flex items-center justify-between text-xs">
                ...
                <button
                  ...
                  className="text-[11px] font-bold text-[#167d4f] hover:underline"
                >
                  {isEditMode
              ...
              {isEditMode ? (
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full py-2 rounded-xl bg-[#167d4f] text-white font-bold text-xs hover:bg-[#167d4f] transition-colors"
                  >
          ...
          {filtered.map((p) => (
            <div
              ...
              className={`p-3.5 flex items-center justify-between gap-3 cursor-pointer hover:bg-slate-50 transition-colors ${
                selectedProperty?.id === p.id ? "bg-[#eaf5f0]/60/70 border-l-4 border-[#167d4f]" : ""
              }`}
            >
